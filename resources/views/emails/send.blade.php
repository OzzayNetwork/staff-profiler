...
<html>
  ...
  <body >
        <div class="header-content">
            <div class="inner">
                <p style="font-family: Montserrat">Hello {{$name}}, <br> You have successfully been added as a member of the Nouveta Limited family! Log in to the website to meet the rest of the team and update your details.</p>
